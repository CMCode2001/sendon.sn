...
const points = [
  "Finis les appels en panique pour trouver un donneur compatible.",
  "Prédictibilité et disponibilité : l'intelligence artificielle au service du système sanguin national.",
  "Données souveraines : respect strict de la loi 2008-12 sur la protection des données personnelles.",
]
        ...
        <Container className="relative grid grid-cols-1 items-center gap-8 lg:grid-cols-2 lg:gap-16">
          ...
          <Reveal className="flex flex-col gap-6">
            ...
            <p className="max-w-[522px] font-display text-base font-medium leading-relaxed text-white/90">
              Une vision claire, une méthode innovante, un impact fort. Découvrez comment SenDon réinvente l'accès au sang, de la collecte à la transfusion.
            </p>
